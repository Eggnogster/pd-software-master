...
class Agency(models.Model):
    ...
    time_zone_id = models.ForeignKey(ListTimeZone)
...
class ReferralType(models.Model):
    ...
    # still need to add stuff: gender, language, emerg contact, license num
class User(models.Model):
    user_id = models.AutoField(primary_key=True)
    username = models.CharField(max_length=50,  unique=True)
    employee_id = models.CharField(max_length=50, null=True)
    employee_type_id = models.ForeignKey(ListEmployeeType, null=True)
    first_name = models.CharField(max_length=50)
    last_name = models.CharField(max_length=50)
    gender = models.CharField(max_length=10, null=True)
    language_id = models.ForeignKey(ListLanguage, null=True)
    ...
    employee_type_id = models.PositiveIntegerField(null=True)
    hire_date = models.DateField(null=True)
    termination_date = models.DateField(null=True)
    staff_status_id = models.ForeignKey(ListStaffStatus, null=True)
...
class ReferralCompany(models.Model):
    ...
    name = models.CharField(max_length=100)
    referral_type_id = models.ForeignKey(ReferralType, null=True)
    website = models.CharField(max_length=100, null=True)
    address1 = models.CharField(max_length=50, null=True)
    address2 = models.CharField(max_length=50, null=True)
    city = models.CharField(max_length=50, null=True)
...
class ReferralContact(models.Model):
    ...
    referral_company_id = models.ForeignKey(ReferralCompany, null=True)
    first_name = models.CharField(max_length=50)
    last_name = models.CharField(max_length=50)
    website = models.CharField(max_length=100, null=True)
    address1 = models.CharField(max_length=50, null=True)
...
class Client(models.Model):
    ...
    language_id = models.ForeignKey(ListLanguage, null=True)
    marital_status_id = models.ForeignKey(ListMaritalStatus, null=True)
    ethnicity_id = models.ForeignKey(ListEthnicity, null=True)
    religion_id = models.ForeignKey(ListReligion, null=True)
    address1 = models.CharField(max_length=50, null=True)
    address2 = models.CharField(max_length=50, null=True)
    city = models.CharField(max_length=50, null=True)
    state = models.CharField(max_length=50, null=True)
    ...
    care_manager_user_id = models.ForeignKey(User, null=True)
    referral_company_id = models.ForeignKey(ReferralCompany, null=True)
    referral_contact_id = models.ForeignKey(ReferralContact, null=True)
    client_status_id = models.ForeignKey(ListClientStatus, null=True)
    status_date = models.DateField(null=True)
    status_note = models.CharField(max_length=400, null=True)
    created_date = models.DateField()
    created_by = models.CharField(max_length=50, null=True)
...
class Caregiver(models.Model):
    ...
    hire_date = models.DateField(null=True)
    termination_date = models.DateField(null=True)
    supervisor_user_id = models.ForeignKey(User, null=True)
    referral_company_id = models.ForeignKey(ReferralCompany, null=True)
    referral_contact_id = models.ForeignKey(ReferralContact, null=True)
    staff_status_id = models.ForeignKey(ListStaffStatus, null=True)
    status_date = models.DateField(null=True)
